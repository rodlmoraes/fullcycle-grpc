...
func (x *CategoryFindRequest) Reset() {
	*x = CategoryFindRequest{}
	mi := &file_proto_course_category_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CategoryFindRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryFindRequest) ProtoMessage() {}

func (x *CategoryFindRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryFindRequest.ProtoReflect.Descriptor instead.
func (*CategoryFindRequest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{4}
}

func (x *CategoryFindRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"categories\"%\n" +
	"\x13CategoryFindRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2\xcb\x02\n" +
	"\x0fCategoryService\x129\n" +
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\x12E\n" +
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x10.pb.CategoryList(\x01\x12P\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category(\x010\x01\x12-\n" +
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.CategoryList\x125\n" +
	"\fFindCategory\x12\x17.pb.CategoryFindRequest\x1a\f.pb.CategoryB\rZ\vinternal/pbb\x06proto3"
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CategoryFindRequest)(nil),   // 4: pb.CategoryFindRequest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.FindCategory:input_type -> pb.CategoryFindRequest
	...
	1, // 10: pb.CategoryService.FindCategory:output_type -> pb.Category
