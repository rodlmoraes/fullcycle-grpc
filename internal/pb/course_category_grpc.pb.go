...
type CategoryServiceClient interface {
	...
	FindCategory(ctx context.Context, in *CategoryFindRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) FindCategory(ctx context.Context, in *CategoryFindRequest, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	FindCategory(context.Context, *CategoryFindRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) FindCategory(context.Context, *CategoryFindRequest) (*Category, error) {
...
func _CategoryService_FindCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindCategory(ctx, req.(*CategoryFindRequest))
	}
	return interceptor(ctx, in, info, handler)
}
